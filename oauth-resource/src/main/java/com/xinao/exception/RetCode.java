...
public enum RetCode {
    ...
    ERR_PARAM_NULL("-24", "请求参数为空"),
    PARAM_INVALID("-25", "参数校验错误"),
    ERR_SAVE_FAILURE("-26", "保存数据失败"),
    ERR_UPDATE_FAILURE("-27", "更新数据失败"),
    ERR_DELETE_FAILURE("-28", "删除数据失败"),
    ERR_RETURNDATA_NULL("-29","查询数据为空"),

    ERR_ENTITY_NULL("-30","实例不存在"),

    ERR_ROLE_CREATE("10","角色创建失败"),
    ERR_ROLE_UPDATE("11","角色修改失败"),
    ERR_ROLE_DELETE("12","角色删除失败"),
    ...
    ERR_RESOURCE_ROLEID_NULL("109", "角色Idnull");
